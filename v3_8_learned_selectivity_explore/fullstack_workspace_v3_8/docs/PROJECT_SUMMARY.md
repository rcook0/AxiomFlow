...
## Latest (v3.8)
- Composition-level selectivity learning (AND predicate groups, join→filter segments)
- Epsilon-greedy exploration of join order variants (single join component)
