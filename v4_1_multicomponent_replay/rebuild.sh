...
# v3.7 quick tests
node backend/tests/test_v3_7_pred_sig.js

# v4 indexes (MongoDB)
# node scripts/db-indexes-v4.js mongodb://localhost:27017 axiomflow

# v4 selection test
node backend/tests/test_v4_ucb_select.js

# v4.1 multi-root variants test
node backend/tests/test_v4_1_multiroot_variants.js
