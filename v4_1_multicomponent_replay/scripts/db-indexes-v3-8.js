 ...
 * db-indexes-v3-8.js
 *
 * Creates MongoDB indexes for v3.8 optimizer artifacts.
 *
 * Usage:
 *   node scripts/db-indexes-v3-8.js mongodb://localhost:27017 axiomflow
 */
...
async function main() {
  ...
  // v3.8 additions
  await db.collection("pred_group_stats").createIndex({ predGroupSig: 1 }, { unique: true });
